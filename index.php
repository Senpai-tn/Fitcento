...
<body>
    ...
    <div class="header_section" style="position: fixed;z-index:100">
            ...
            <div class="row">
                ...
                <div class="overlay-content">
                  ...
                  if (isset($_SESSION['id'])) {
                      echo '<a href="Controler/LogoutControler.php">Logout</a>';
                  } else {
                      echo '<a href="logins.php">LOGIN</a>
                  <a href="logins.php">REGISTER</a>';
                  }
                  ?>
                </div>
                </div>
  ...
  <a class="carousel-control-next" href="#my_Controls" role="button" data-slide="next">
    ...
    <!-- banner section end -->
    <!-- about section start -->
    <div class="about_section_2 layout_padding" id="about">
        <div class="container">
    ...
    <div class="our_section layout_padding" id="class">
    	<div class="container">
    		<h1 class="our_text"><strong>OUR CLASSES</strong></h1>
    		<p class="client_long_text">It is a long established fact that a reader will be distracted by the readable</p>
    		<div class="row padding_top_0">
    			<div class="col-lg-4">
    				<div class="image_7"><img src="images/img-1.png"></div>
    		    ...
    		    <div class="col-lg-4">
    		    	<div class="image_7"><img src="images/img-2.png"></div>
    				<h2 class="design_text">INDOOR CYCLING</h2>
    				<p class="fact_text">It is a long established fact that a reader will be distracted by the readable</p>
    		    </div>
    		    <div class="col-lg-4">
    		    	<div class="image_7"><img src="images/img-3.png"></div>
    ...
    <div class="our_price_section layout_padding" id="price">
    	<div class="container">
            ...
            <div class="price_section_2">
            	<div class="row">
                   ...
                   echo '<div class="select_boton">
            			    <div class="select_bt">
                        <a href="paiement.php?plan=BEGINNER">SELECT PLAN</a>
                      </div>
            			</div>';
               } ?>
            		</div>
                   ...
                   echo '<div class="select_boton">
            			    <div class="select_bt">
                      <a href="paiement.php?plan=PREMIUM">SELECT PLAN</a>
                      </div>
            			</div>';
               } ?>
            		</div>
                   ...
                   echo '<div class="select_boton">
            			    <div class="select_bt">
                      <a href="paiement.php?plan=ULTIMATE">SELECT PLAN</a>
                      </div>
            			</div>';
               } ?>
            		</div>
    ...
    <div class="about_section_2 layout_padding" id="contact">
        <div class="container">
    ...
    <div class="contact_section">
    	<div class="row">
            ...
            <form action="Controler/MessageController.php" method="POST">
